...
document_file_operations.file = $$PWD/tst_DocumentFileOperations.pro
document_file_operations.makefile = Makefile.DocumentFileOperations

markdown_render_state.file = $$PWD/tst_MarkdownRenderState.pro
markdown_render_state.makefile = Makefile.MarkdownRenderState

conversion_error_presentation.file = $$PWD/tst_ConversionErrorPresentation.pro
conversion_error_presentation.makefile = Makefile.ConversionErrorPresentation

markdown_document_renderer.file = $$PWD/tst_MarkdownDocumentRenderer.pro
